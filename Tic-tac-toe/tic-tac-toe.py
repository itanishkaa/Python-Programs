from tkinter import * #access UI functions
import tkinter.messagebox

root=Tk()
root.geometry("1390x750+0+0")
...
def Newgame():
    ...
    nmPlayerX=Entry(RightFrame1,font=('arial',40,'bold'),bd=3,fg='black',textvariable=Player1,width=7,justify=LEFT).grid(row=1,column=1)
    
    nmPlayerO=Entry(RightFrame1,font=('arial',40,'bold'),bd=3,fg='black',textvariable=Player2,width=7,justify=LEFT).grid(row=1,column=1)

lblPlayerX=Label(RightFrame1,font=('arial',40,'bold'),text="Player X :",padx=2,pady=2,bg='yellow',fg='black')
lblPlayerX.grid(row=0,column=0,sticky=W)

nmPlayerX=Entry(RightFrame1,font=('arial',40,'bold'),bd=3,fg="black",textvariable=Player1,width=7,justify=LEFT).grid(row=0,column=1)
